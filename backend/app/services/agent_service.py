...
def get_strict_plan_schema() -> Dict[str, Any]:
    """
    OpenAI JSON schema response_format requires additionalProperties=false
    on all object types.
    """
    schema = deepcopy(PlanDraft.model_json_schema())
